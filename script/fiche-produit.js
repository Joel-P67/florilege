document.addEventListener('DOMContentLoaded', () => {
  const fichiersJson = [
    '/florilege/ambiance-et-bien-etre/bougies-parfumees.json',
    '/florilege/ambiance-et-bien-etre/huiles-essentielles.json',
    '/florilege/ambiance-et-bien-etre/parfums.json',
    '/florilege/ambiance-et-bien-etre/savons.json',
    '/florilege/fleurs-fraiches/bouquets-fleurs-fraiches-astrologie.json',
    '/florilege/fleurs-fraiches/bouquets-fleurs-fraiches-automne.json',
    '/florilege/fleurs-fraiches/bouquets-fleurs-fraiches-deuil.json',
    '/florilege/fleurs-fraiches/bouquets-fleurs-fraiches-ete.json',
    '/florilege/fleurs-fraiches/bouquets-fleurs-fraiches-hiver.json',
    '/florilege/fleurs-fraiches/bouquets-fleurs-fraiches-printemps.json',
    '/florilege/fleurs-fraiches/ornements-fleurs-fraiches-astrologie.json',
    '/florilege/fleurs-fraiches/ornements-fleurs-fraiches-automne.json',
    '/florilege/fleurs-fraiches/ornements-fleurs-fraiches-deuil.json',
    '/florilege/fleurs-fraiches/ornements-fleurs-fraiches-ete.json',
    '/florilege/fleurs-fraiches/ornements-fleurs-fraiches-hiver.json',
    '/florilege/fleurs-fraiches/ornements-fleurs-fraiches-printemps.json',
    '/florilege/fleurs-sechees/bouquets-fleurs-sechees-astrologie.json',
    '/florilege/fleurs-sechees/bouquets-fleurs-sechees-automne.json',
    '/florilege/fleurs-sechees/bouquets-fleurs-sechees-deuil.json',
    '/florilege/fleurs-sechees/bouquets-fleurs-sechees-ete.json',
    '/florilege/fleurs-sechees/bouquets-fleurs-sechees-hiver.json',
    '/florilege/fleurs-sechees/bouquets-fleurs-sechees-printemps.json',
    '/florilege/fleurs-sechees/ornements-fleurs-sechees-astrologie.json',
    '/florilege/fleurs-sechees/ornements-fleurs-sechees-automne.json',
    '/florilege/fleurs-sechees/ornements-fleurs-sechees-deuil.json',
    '/florilege/fleurs-sechees/ornements-fleurs-sechees-ete.json',
    '/florilege/fleurs-sechees/ornements-fleurs-sechees-hiver.json',
    '/florilege/fleurs-sechees/ornements-fleurs-sechees-printemps.json',
    '/florilege/gourmandises/boites-de-chocolats.json',
    '/florilege/gourmandises/bouquets-de-friandises.json',
    '/florilege/gourmandises/sucreries.json',
    '/florilege/outils-vases-pots/outils.json',
    '/florilege/outils-vases-pots/pots.json',
    '/florilege/outils-vases-pots/vases.json',
    '/florilege/plantes/a-feuilles.json',
    '/florilege/plantes/a-fleurs.json',
    '/florilege/terrariums/terrariums-moyens.json',
    '/florilege/terrariums/terrariums-grands.json',
    '/florilege/terrariums/terrariums-petits.json',
  ];
      ...
      `;
            tailles.forEach((taille) => {
              ...
              if (prix !== undefined) {
                ...
                tarifsHTML += `
            <tr>
              <td><img src="/florilege/menu-img/feuille.png" alt="Icône de feuille" width="24" height="24"></td>
